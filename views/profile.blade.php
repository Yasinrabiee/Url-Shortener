		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="navbarNav">
				<ul class="navbar-nav me-auto">
					...
					<li class="nav-item">
						<a class="nav-link" href="./dashboard.php">لینک‌های من</a>
					</li>
				</ul>
        <div class="d-flex">
  ...
  <div class="container">
    <div class="login-container">
      <h1 class="h2 mb-3 text-center">
      	<span class="badge bg-primary">پروفایل شما</span>
    	</h1>
    	<div class="my-2">
    	...
    	<form action="profile.php" method="post">
    	  <div class="mb-3">
    	    ...
    	    value="{{ formData.username ?? userInfo.username }}" dir="ltr">
    	    <small>
    	  ...
    	  <div class="mb-3">
    	    ...
    	    <input type="text" name="fname" class="form-control" id="fname"
    	     value="{{ formData.fname ?? userInfo.fname }}">
    	  </div>
    	  <div class="mb-3">
    	    ...
    	    <input type="text" name="lname" class="form-control" id="lname"
    	     value="{{ formData.lname ?? userInfo.lname }}">
    	  </div>
    	  <div class="mb-3">
